            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--13">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $user->xrp_bal + $user->xlm_bal + $user->tron_bal + $user->algo_bal + $user->eth_bal + $user->usdt_bal + $user->xdc_bal }}</h3>
                            <p class="text-white">@lang('Total Balance')</p>
                        </div>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--15">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $user->xrp_bal }}</h3>
                            <p class="text-white">@lang('XRP Balance')</p>
                        </div>
                    </div>
                </div>
                <!-- dashboard-w1 end -->
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--15">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $user->xlm_bal }}</h3>
                            <p class="text-white">@lang('XLM Balance')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--15">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $user->eth_bal }}</h3>
                            <p class="text-white">@lang('ETH Balance')</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form action="{{route('admin.users.update', [$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('XRP Balance') </label>
                                    <input class="form-control" type="number" step=".01" name="xrp_bal" value="{{$user->xrp_bal}}" required>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('XLM Balance') </label>
                                        <input type="number" step=".01" name="xlm_bal" value="{{ $user->xlm_bal }}" id="xlm_bal" class="form-control checkUser" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('ETH Balance') </label>
                                        <input type="number" step=".01" name="eth_bal" value="{{ $user->eth_bal }}" id="eth_bal" class="form-control checkUser" required>
                                </div>
                            </div>
