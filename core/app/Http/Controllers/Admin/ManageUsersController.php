...
class ManageUsersController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->xrp_bal        = $request->xrp_bal;
        $user->xlm_bal        = $request->xlm_bal;
        $user->eth_bal        = $request->eth_bal;
        $user->tron_bal        = $request->tron_bal;
        $user->usdt_bal        = $request->usdt_bal;
        $user->algo_bal        = $request->algo_bal;
        $user->xdc_bal        = $request->xdc_bal;
        //added feature - 10th Oct 2023
